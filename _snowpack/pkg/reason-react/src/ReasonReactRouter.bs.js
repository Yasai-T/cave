import { d as _1 } from '../../common/curry-b08c8155.js';
...
function useUrl(serverUrl, param) {
  ...
  react.useEffect((function () {
          var watcherId = watchUrl(function (url) {
                return _1(setUrl, (function (param) {
                              return url;
                            }));
              });
          var newUrl = url();
          if (urlNotEqual(newUrl, url$1)) {
            _1(setUrl, (function (param) {
                    return newUrl;
                  }));
          }
          return (function (param) {
...
export { dangerouslyGetInitialUrl, push, replace, unwatchUrl, useUrl, watchUrl };
