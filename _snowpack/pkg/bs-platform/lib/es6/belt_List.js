import { _ as __1, a as __2, b as __3 } from '../../../common/curry-b08c8155.js';
import { y as blitUnsafe, ae as some$1, c as shuffleInPlace, W as reduceReverseU$1, Y as reduceReverse2U$1, af as valFromOption } from '../../../common/belt_Array-cee0349c.js';
...
function forEachWithIndex(l, f) {
  return forEachWithIndexU(l, __2(f));
}
...
function reduceReverseU(l, acc, f) {
  ...
  if (len < 1000) {
    ...
    return reduceReverseU$1(toArray(l), acc, f);
  }
}

function reduceReverse(l, accu, f) {
  return reduceReverseU(l, accu, __2(f));
}
...
function reduceWithIndex(l, acc, f) {
  return reduceWithIndexU(l, acc, __3(f));
}
...
function mapReverse2(l1, l2, f) {
  return mapReverse2U(l1, l2, __2(f));
}
...
function reduce2(l1, l2, acc, f) {
  return reduce2U(l1, l2, acc, __3(f));
}
...
function reduceReverse2U(l1, l2, acc, f) {
  ...
  if (len < 1000) {
    ...
    return reduceReverse2U$1(toArray(l1), toArray(l2), acc, f);
  }
}

function reduceReverse2(l1, l2, acc, f) {
  return reduceReverse2U(l1, l2, acc, __3(f));
}
...
function removeAssoc(xs, x, eq) {
  return removeAssocU(xs, x, __2(eq));
}
...
function setAssoc(xs, x, k, eq) {
  return setAssocU(xs, x, k, __2(eq));
}
...
function keepWithIndex(xs, p) {
  return keepWithIndexU(xs, __2(p));
}
...
export { add, cmp, cmpByLength, cmpU, concat, concatMany, drop, eq, eqU, every, every2, every2U, everyU, filter, filterWithIndex, flatten, forEach, forEach2, forEach2U, forEachU, forEachWithIndex, forEachWithIndexU, fromArray, get, getAssoc, getAssocU, getBy, getByU, getExn, has, hasAssoc, hasAssocU, hasU, head, headExn, keep, keepMap, keepMapU, keepU, keepWithIndex, keepWithIndexU, length, make, makeBy, makeByU, map, mapReverse, mapReverse2, mapReverse2U, mapReverseU, mapU, mapWithIndex, mapWithIndexU, partition, partitionU, reduce, reduce2, reduce2U, reduceReverse, reduceReverse2, reduceReverse2U, reduceReverseU, reduceU, reduceWithIndex, reduceWithIndexU, removeAssoc, removeAssocU, reverse, reverseConcat, setAssoc, setAssocU, shuffle, size, some, some2, some2U, someU, sort, sortU, splitAt, tail, tailExn, take, toArray, unzip, zip, zipBy, zipByU };
